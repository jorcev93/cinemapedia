...
class HomeScreen extends StatelessWidget {
  ...
  final StatefulNavigationShell currentChild;//este childView vamos a tener que recibirlo si lo queremos utilizar
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: currentChild,
      bottomNavigationBar: CustomBottomNavigation(currentChild: currentChild,), //mandamos a llamar el menu de navegacion que se muestra en la parte inferior
